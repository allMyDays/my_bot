...
import com.example.my_bot.command.commands.immunity.RemoveImmunityCommand;
...
class RemoveImmunityCommandTest {
    ...
    private RemoveImmunityCommand removeImmunityCommand;

    @BeforeEach
    void setUp() {
        removeImmunityCommand = new RemoveImmunityCommand(
                vkChatClient,
                memberService,
                userInputResolver,
                userService,
    ...
    void shouldReturnArgumentValidationErrorWhenNoMemberFound() throws ClientException, ApiException {
        ...
        CommandExecutionStatus status = removeImmunityCommand.execute(commandMessage);
        ...
        verify(memberService, never()).removeImmunityFromMember(anyLong(), anyLong(), anyLong());
    }
    ...
    void shouldReturnBusinessLogicErrorOnMemberException() throws ClientException, ApiException {
        ...
        doThrow(exception).when(memberService).removeImmunityFromMember(CHAT_ID, USER_TO_ALTER, FROM_ID);
    ...
    void shouldPropagateClientExceptionFromVkChatClientSendText() throws ClientException, ApiException {
        ...
        doNothing().when(memberService).removeImmunityFromMember(CHAT_ID, USER_TO_ALTER, FROM_ID);
        when(userService.getUserFullNameInRequiredCase(USER_TO_ALTER, NameCase.GENITIVE))
        ...
        assertThrows(ClientException.class, () -> removeImmunityCommand.execute(commandMessage));
        verify(vkChatClient).sendText(sendMessageDto);
    }
    ...
    void shouldPropagateApiExceptionFromVkChatClientSendText() throws ClientException, ApiException {
        ...
        assertThrows(ApiException.class, () -> removeImmunityCommand.execute(commandMessage));
        verify(vkChatClient).sendText(sendMessageDto);
    }
    ...
    void shouldPropagateRuntimeExceptionFromMemberService() throws ClientException, ApiException {
        ...
        doThrow(runtimeException).when(memberService).removeImmunityFromMember(CHAT_ID, USER_TO_ALTER, FROM_ID);

        assertThrows(RuntimeException.class, () -> removeImmunityCommand.execute(commandMessage));
