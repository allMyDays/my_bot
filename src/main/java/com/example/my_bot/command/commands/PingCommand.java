...
@Slf4j
@Command(mainCommandName = "пинг", alternativeCommandNames = {"ping"}, defaultRole = MEMBER, eventable = true, onlyForConversations = false, adminChatCommandExecutionMode = ONLY_IN_ADMIN_CHAT)
...
public class PingCommand implements ChatCommand {
    ...
    public CommandExecutionStatus execute(CommandMessageDto commandMessage) throws ClientException, ApiException {
       ...
       vkChatClient.sendText(messageMapper.toSendMessageDto("ПОНГ",commandMessage));
