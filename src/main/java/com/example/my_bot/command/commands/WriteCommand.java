...
@Slf4j
@Command(mainCommandName = "напиши", alternativeCommandNames = {"write"}, defaultRole = MEMBER, eventable = true)
...
public class WriteCommand implements ChatCommand {
    ...
    public void execute(CommandMessageDto messageDto) throws ClientException, ApiException {
        ...
        vkChatClient.sendText(messageMapper.toSendMessageDto(text,messageDto));
