...
public class MessageConstant {
    ...
    public static final String UNKNOWN_ERROR_MESSAGE = "При обработке запроса произошла ошибка. Пожалуйста, сообщите разработчику.";
    ...
    public static final String NOT_ENOUGH_ROLE_TO_INTERACT_WITH_MEMBER = "Роль этого участника выше или равна Вашей роли.";
